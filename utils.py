...
<div style="position: absolute; z-index: 99999">
      ...
      <div style="padding-top: 0; padding-bottom: auto;">
        <div style="width:100%;height:auto;position:fixed;text-align:center;font-size:0;bottom:0;left:0;right:0;margin:auto">
          <label for="aadsstickymplslsca" style="top: 50%;transform: translateY(-50%);right:12px;; position: absolute;border-radius: 3px; background: rgba(248, 248, 249, 0.70); padding: 2px;z-index: 99999;cursor:pointer;line-height:1">
